...
QtObject {
    ...
    readonly property bool resolvedDark: Settings.themeMode === 2 || (Settings.themeMode === 0 && Application.styleHints.colorScheme === Qt.Dark)
    ...
    readonly property var palettes: ({
            cubed: {
                ...
                dark: {
                    primary: "#AED066",
                    onPrimary: "#233600",
                    primaryContainer: "#344F00",
                    onPrimaryContainer: "#C9F283",
                    secondary: "#C0CBAE",
                    onSecondary: "#2B331F",
                    secondaryContainer: "#414A34",
                    onSecondaryContainer: "#DCE7C8",
                    tertiary: "#FFB692",
                    onTertiary: "#542104",
                    tertiaryContainer: "#713719",
            ...
            orange: {
                light: {
                    ...
                    tertiary: "#626033",
                    onTertiary: "#FFFFFF",
                    tertiaryContainer: "#E8E4AC",
                    onTertiaryContainer: "#1E1D00"
                },
                dark: {
                    primary: "#FFB689",
                    onPrimary: "#522300",
                    primaryContainer: "#743500",
                    onPrimaryContainer: "#FFDBC7",
                    secondary: "#E6BEA7",
                    onSecondary: "#432B1C",
                    secondaryContainer: "#5C412F",
                    onSecondaryContainer: "#FFDBC7",
                    tertiary: "#CBC890",
                    onTertiary: "#343209",
                    tertiaryContainer: "#4A491E",
                    onTertiaryContainer: "#E8E4AC"
                }
            }
        })
